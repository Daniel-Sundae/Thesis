...
Began with rivest, adleman and Dertouzos in 1978 and the paper about Data Banks. To perform homomorphic evaluation on arbitrary functions, a scheme needs to support unlimited number of multiplication and addition of ciphertexts.

RSA supports multitplication,

Paillier supports addition.

% Source fo below: Gentry rundown https://www.youtube.com/watch?v=487AjvFW1lk&t=2s 
First generation:
