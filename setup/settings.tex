...
\chapterfont{\sffamily\fontsize{14}{15}}
\sectionfont{\sffamily\fontsize{13}{15}}
...
% \newcommand{\bigboxdot}{\mathrel{\scalebox{1.5}{$\boxdot$}}} % Adjust the number 2 for scaling
\DeclareMathOperator*{\bigboxdot}{\scalebox{1.5}{$\boxdot$}}
% \newcommand{\bigboxplus}{\mathop{\scalebox{1.5}{$\boxplus$}\limits}}
\DeclareMathOperator*{\bigboxplus}{\scalebox{1.5}{$\boxplus$}}
\newcommand{\boxringhelp}{\ooalign{$\square$\cr\hidewidth\raisebox{.6ex}{\scalebox{.3}{\textcircled{\raisebox{-.9pt} {}}}}\hidewidth\cr}}
\newcommand{\boxring}{\mathop{\boxringhelp}}
\newcommand{\bigboxringhelp}{
  \ooalign{
    $\scalebox{1.8}{$\square$}$\cr
    \hidewidth\raisebox{1.1ex}{\scalebox{0.6}{\textcircled{\raisebox{-0.9pt} {}}}}\hidewidth\cr
  }
}
\newcommand{\bigboxring}{\mathop{\bigboxringhelp}}
...
\usepackage{titlesec}
\titleformat{\chapter}[block]  % change "display" to "block"
  {\normalfont\huge\bfseries}{\thechapter.}{1em}{\Huge}
  \titlespacing*{\chapter}{0pt}{*4}{*2.5}
\titleformat{\section}[block]  % change "display" to "block"
  {\normalfont\Large\bfseries}{\thesection}{1em}{}
\titlespacing*{\section}{0pt}{*2}{*1}

% For python code insertion
\usepackage{listings}
...
%\usepackage[hidelinks]{hyperref}		% Clickable links. Specifically behind tocloft.
\usepackage{hyperref}
